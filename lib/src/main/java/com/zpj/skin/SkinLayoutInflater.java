...
//        Log.d(TAG, "addElement view=" + view);
        SkinElement skinElement = new SkinElement(view);

//        final int[] atts = new int[] { android.R.attr.textColor, android.R.attr.background,  android.R.attr.foreground };
//        TypedArray a = view.getContext().obtainStyledAttributes(
//                attrs, atts, 0, 0);
//        int N = a.getIndexCount();
//        for (int i = 0; i < N; i++) {
//            a.getNonResourceString(i);
//            a.get
//        }
//        a.recycle();
...
//            Log.d(TAG, "addElement name=" + name + " value=" + value);
...
//        Log.d(TAG, "addElement view=" + view + " size=" + skinElement.changeAttrs.size());
...
////            }
//
//            if (value.startsWith("?") || ("style".equalsIgnoreCase(name) && value.startsWith("@"))){
//                try {
//                    String temp = value.substring(1);
//                    int attrId = Integer.parseInt(temp);
//                    skinElement.changeAttrs.put(name, attrId);
...
//            }
//
////            if ("style".equalsIgnoreCase(name) && value.startsWith("@")) {
////                String temp = value.substring(1);
////                int attrId = Integer.parseInt(temp);
//////                addElement(view, Xml.asAttributeSet(view.getContext().getResources().getXml(attrId)));
...
//    }
     ...
     * @Date: 2019/1/31
     */
    private static class SkinElement extends WeakReference<View> {
